...
Public Class Form1
    ...
    Private Sub InicioJuego_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim im1(8), tmp, i, j, flag As Integer
        flag = 0

        Randomize()

        For i = 0 To 8 Step 1
            tmp = CInt(Int((8 * Rnd() + 1)))
            For j = 0 To 8 Step 1
                If im1(j) = tmp Then
                    flag = 1
                End If
        ...
        PictureBox1.Image = ImageList1.Images(im1(0) - 1)
        PictureBox2.Image = ImageList1.Images(im1(1) - 1)
        PictureBox3.Image = ImageList1.Images(im1(2) - 1)
        PictureBox4.Image = ImageList1.Images(im1(3) - 1)
        PictureBox6.Image = ImageList1.Images(im1(4) - 1)
        PictureBox5.Image = ImageList1.Images(im1(5) - 1)
        PictureBox7.Image = ImageList1.Images(im1(6) - 1)
        PictureBox8.Image = ImageList1.Images(im1(7) - 1)
        PictureBox9.Image = ImageList1.Images(im1(8) - 1)
        ...
        '' version 3
        'Johnny Riveros.
        'Este codigo es para que la imagenes no se puedan mover anter de hacer clic en el boton iniciar juego.
    ...
    Private Function PictureBox(ByVal p1 As Object) As Integer
